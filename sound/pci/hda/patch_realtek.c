...
enum {
	...
	ALC269VB_FIXUP_AYANEO_AIR_PLUS,
...
static const struct snd_pci_quirk alc269_fixup_tbl[] = {
	...
	SND_PCI_QUIRK(0x1f66, 0x0103, "AIR Plus", ALC269VB_FIXUP_AYANEO_AIR_PLUS),
...
static const struct hda_model_fixup alc269_fixup_models[] = {
	...
	{.id = ALC269VB_FIXUP_AYANEO_AIR_PLUS, .name = "ayaneo-air-plus"},
